...
(function() {
  ...
  function ScrollManager(element) {
    ...
    // Add scroll listener
    element.addEventListener('scroll', this.handleScroll, this.eventListenerOptions);
  }
  ...
  ScrollManager.prototype.getScrollPosition = function() {
    ...
    var scrollPositionY = this.element.scrollTop;
    var scrollPositionX = this.element.scrollLeft;
    ...
    var minPixel = this.element.offsetTop;
    var maxPixel = minPixel + this.element.scrollHeight;
    // var value = document.body.scrollTop;

    // respect bounds of element
    var percent = (scrollPositionY - minPixel)/(maxPixel - minPixel);
